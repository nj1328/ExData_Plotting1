...
## Create four separate plots and copy to plot4.png
...
plot(hh_data$Date, hh_data$Voltage, type = "l", xlab = "datetime",
     ylab = "Voltage", xaxt="n")
axis.POSIXct(1, hh_data$Date, format = "%a", at=pretty(hh_data$Date, n=2))
...
plot(hh_data$Date, hh_data$Global_reactive_power, type = "l", xlab = "datetime",
